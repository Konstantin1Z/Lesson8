...
var noviRabotnik = new rabotnik(
  ...
  d, 
  d,//document.getElementById('xxx').options[document.getElementById('xxx').selectedIndex].text, 
  document.getElementById("Wauto").value,
  document.getElementById("KolDet").value, 
  c, // document.getElementById('xxx2').options[document.getElementById('xxx2').selectedIndex].text, 
  c, // document.getElementById('xxx1').options[document.getElementById('xxx1').selectedIndex].text, 
  c, // document.getElementById('xxx3').options[document.getElementById('xxx3').selectedIndex].text,
...
// $.ajax('http://localhost:2403/worker', {
//   type: "POST",
...
let url = 'http://localhost:2403/worker';
